	...
	return (
		<section className={style.content}>
			...
			<article className={style.content__img}>
				...
				<h2 className={style.header__img} onClick={handleChildrenClick}>Наша молодежь</h2> 
				 </div> 
				 </article>
			...
			<div className={style.img__block}>
				...
				<h2 className={style.header__img} onClick={handleHelpClick}>Помогаем в трудную минуту</h2>
				 </div> 
				 </article> 
			...
			<div className={style.img__block}>
				...
				<h2 className={style.header__img} onClick={handleGalleryClick}>Галерея</h2> 
				 </div> 
				 </article>

...
import style from '../HomePage/ModalHomePage.module.scss';
...
export default function ModalHomePage({active, setActive}){
    return(
        ...
        <button onClick={()=>setActive(false)} className={style.close__btn}><img src={closeImg} alt="Закрыть" className={style.close__img}/></button>
        </div>
